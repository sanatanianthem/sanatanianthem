...
const DEFAULT_NAV = [
  ...
  { emoji:'✈',  label:'Book Yatra',     url:'index.html#travel',     visible:true },
...
.uh-brand { font-family:'Raleway',sans-serif;font-weight:900;font-size:1.9rem;letter-spacing:2px;line-height:1; }
.uh-brand .uh-s { color:#8B2500;text-shadow:0 0 8px rgba(255,255,255,1),0 0 16px rgba(255,255,255,.9),0 0 28px rgba(255,255,255,.7),0 0 6px rgba(139,37,0,.5); }
.uh-brand .uh-a { color:#004d00;text-shadow:0 0 8px rgba(255,255,255,1),0 0 16px rgba(255,255,255,.9),0 0 28px rgba(255,255,255,.7),0 0 6px rgba(0,77,0,.4); }
...
try {
  ...
  onSnapshot(doc(db, 'siteConfig', 'main'), snap => {
    ...
    if (nav && nav.length) renderHeader(nav);
  });
} catch(e) {
